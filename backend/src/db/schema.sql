-- CargoNotify Database Schema (Multi-Tenant)
...
CREATE TABLE IF NOT EXISTS containers (
    ...
    actual_arrival DATE,
    status VARCHAR(50) DEFAULT 'in_transit', -- in_transit, arrived, closed
    notes TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS container_costs (
    ...
    category VARCHAR(100) NOT NULL, -- freight, customs, transport, other
...
CREATE TABLE IF NOT EXISTS pricing_services (
    ...
    unit_type VARCHAR(50) NOT NULL DEFAULT 'per_cbm', -- per_cbm, per_unit
    description TEXT,
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS lots (
    ...
    pickup_status VARCHAR(50) DEFAULT 'pending', -- pending, picked_up
    pickup_date DATE,
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_method VARCHAR(50) DEFAULT 'cash', -- cash, wave, om, bank_transfer
...
CREATE TABLE IF NOT EXISTS expenses (
    ...
    category VARCHAR(100) NOT NULL DEFAULT 'other', -- salary, transport, handling, container, rent, other
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    action_type VARCHAR(50) DEFAULT 'info', -- create, update, delete, auth, communication, export
    entity_type VARCHAR(100), -- lot, container, client, payment, expense, user, whatsapp
    entity_id INT,
